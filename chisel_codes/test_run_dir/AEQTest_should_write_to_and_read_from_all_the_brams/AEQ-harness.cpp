...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/rahul/FPGA-acceleration-of-SNN/chisel_codes/test_run_dir/AEQTest_should_write_to_and_read_from_all_the_brams/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_writeEnable_0 = u; break;
      case 2 : dut->io_writeEnable_1 = u; break;
      case 3 : dut->io_writeEnable_2 = u; break;
      case 4 : dut->io_writeEnable_3 = u; break;
      case 5 : dut->io_writeEnable_4 = u; break;
      case 6 : dut->io_writeEnable_5 = u; break;
      case 7 : dut->io_writeEnable_6 = u; break;
      case 8 : dut->io_writeEnable_7 = u; break;
      case 9 : dut->io_writeEnable_8 = u; break;
      case 10 : dut->io_readEnable = u; break;
      case 11 : dut->io_writeData_0 = u; break;
      case 12 : dut->io_writeData_1 = u; break;
      case 13 : dut->io_writeData_2 = u; break;
      case 14 : dut->io_writeData_3 = u; break;
      case 15 : dut->io_writeData_4 = u; break;
      case 16 : dut->io_writeData_5 = u; break;
      case 17 : dut->io_writeData_6 = u; break;
      case 18 : dut->io_writeData_7 = u; break;
      case 19 : dut->io_writeData_8 = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_writeEnable_0; break;
      case 2 : value = dut->io_writeEnable_1; break;
      case 3 : value = dut->io_writeEnable_2; break;
      case 4 : value = dut->io_writeEnable_3; break;
      case 5 : value = dut->io_writeEnable_4; break;
      case 6 : value = dut->io_writeEnable_5; break;
      case 7 : value = dut->io_writeEnable_6; break;
      case 8 : value = dut->io_writeEnable_7; break;
      case 9 : value = dut->io_writeEnable_8; break;
      case 10 : value = dut->io_readEnable; break;
      case 11 : value = dut->io_writeData_0; break;
      case 12 : value = dut->io_writeData_1; break;
      case 13 : value = dut->io_writeData_2; break;
      case 14 : value = dut->io_writeData_3; break;
      case 15 : value = dut->io_writeData_4; break;
      case 16 : value = dut->io_writeData_5; break;
      case 17 : value = dut->io_writeData_6; break;
      case 18 : value = dut->io_writeData_7; break;
      case 19 : value = dut->io_writeData_8; break;
      case 20 : value = dut->io_readData_0; break;
      case 21 : value = dut->io_readData_1; break;
      case 22 : value = dut->io_readData_2; break;
      case 23 : value = dut->io_readData_3; break;
      case 24 : value = dut->io_readData_4; break;
      case 25 : value = dut->io_readData_5; break;
      case 26 : value = dut->io_readData_6; break;
      case 27 : value = dut->io_readData_7; break;
      case 28 : value = dut->io_readData_8; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/rahul/FPGA-acceleration-of-SNN/chisel_codes/test_run_dir/AEQTest_should_write_to_and_read_from_all_the_brams/AEQ.vcd)";
