...
#ifndef VERILATED_VAEQ_H_
#define VERILATED_VAEQ_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"

class VAEQ__Syms;
class VAEQ___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class VAEQ VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit VAEQ(VerilatedContext* contextp, const char* name = "TOP");
    explicit VAEQ(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VAEQ();
  private:
    VL_UNCOPYABLE(VAEQ);  ///< Copying not allowed
