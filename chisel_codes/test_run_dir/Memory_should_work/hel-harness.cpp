...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/rahul/FPGA-acceleration-of-SNN/chisel_codes/test_run_dir/Memory_should_work/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_rdAddr = u; break;
      case 2 : dut->io_wrAddr = u; break;
      case 3 : dut->io_wrData = u; break;
      case 4 : dut->io_wrEna = u; break;
      case 5 : dut->io_rdEna = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_rdAddr; break;
      case 2 : value = dut->io_wrAddr; break;
      case 3 : value = dut->io_wrData; break;
      case 4 : value = dut->io_wrEna; break;
      case 5 : value = dut->io_rdEna; break;
      case 6 : value = dut->io_rdData; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/rahul/FPGA-acceleration-of-SNN/chisel_codes/test_run_dir/Memory_should_work/hel.vcd)";
