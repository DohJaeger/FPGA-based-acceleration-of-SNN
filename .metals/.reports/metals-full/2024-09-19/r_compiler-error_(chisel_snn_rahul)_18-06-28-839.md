file://<WORKSPACE>/src/main/scala/sync_mem.scala
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/sync_mem.scala,line-4,offset=188
...
action parameters:
offset: 188
uri: file://<WORKSPACE>/src/main/scala/sync_mem.scala
text:
```scala
                                                                                                          
//> using scala "2.13.12"
//> using dep  "org.chipsalliance::chisel::6.0.0"
//> u@@sing plugin "org.chipsalliance:::chisel-plugin::6.0.0"
//> using options "-unchecked", "-deprecation", "-language:reflectiveCalls", "-feature", "-Xfatal-warnings", "-Ywarn-dead-code", "-Ywarn-unused", "-Ymacro-annotations"
